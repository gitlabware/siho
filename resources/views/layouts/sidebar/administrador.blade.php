...
<aside class="main-sidebar">
    ...
    <!-- search form (Optional) -->
        ...
        <ul class="sidebar-menu">
            ...
            <li class="active"><a href="{{ url('pasajeros_reporte') }}"><i class='fa fa-building-o'></i> <span>Reporte de Pasajeros</span></a></li>
            <li class="active"><a href="{{ url('reporte_pagos') }}"><i class='fa fa-building-o'></i> <span>Reporte de Cajas</span></a></li>
            <li class="active"><a href="{{ url('repo_pago_regis') }}"><i class='fa fa-building-o'></i> <span>Reporte de Pagos</span></a></li>
        </ul><!-- /.sidebar-menu -->
    </section>
    <!-- /.sidebar -->
</aside>
