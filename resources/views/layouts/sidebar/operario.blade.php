...
<aside class="main-sidebar">
    ...
    <!-- Sidebar Menu -->
        <ul class="sidebar-menu">
            ...
            <li class=""><a href="{{ url('clientes') }}"><i class='fa fa-user-secret'></i> <span>Clientes</span></a>
            </li>
            ...
            <li class=""><a href="{{ url('vhabitaciones') }}"><i class='fa fa-cubes'></i>
                    <span>Cuadro Habitaciones</span></a>
            </li>
